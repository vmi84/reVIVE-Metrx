/**
 * WhoopMetricRow — Editable metric with source badge and accept/edit buttons.
 */
...
import { MetricSource } from '../../lib/types/feed';
...
const SOURCE_COLORS: Record<MetricSource, string> = {
  ...
  inherited: COLORS.warning,
  computed: COLORS.textMuted,
};
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.labelRow}>
        ...
        <View style={[styles.sourceBadge, { backgroundColor: SOURCE_COLORS[source] + '20' }]}>
          <ThemedText variant="caption" style={[styles.sourceText, { color: SOURCE_COLORS[source] }]}>
