      ...
      iaci: i === 0 ? null : { // Today has no IACI yet (needs check-in)
        ...
        protocol: {
          ...
          trainingCompatibility: {
            zone1: 'recommended', zone2: 'recommended', intervals: 'allowed',
            tempo: 'allowed', strengthHeavy: 'caution', strengthLight: 'recommended',
            techniqueDrill: 'recommended', plyometrics: 'caution',
          },
