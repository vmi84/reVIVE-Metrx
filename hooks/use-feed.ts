  ...
  if (phys?.iaci_score != null && phys?.readiness_tier != null) {
    ...
    iaci = {
      ...
      protocol: {
        ...
        confidenceNote: null,
        driverInsight: null,
        permutationKey: 'band_C_none_unknown_none',
      },
      baseScore: phys.iaci_score,
      dataCompleteness: phys.data_completeness ?? 0,
      confidence: phys.data_completeness ?? 0,
      confidenceLevel: 'medium' as const,
      confidenceFactors: [],
      trendContext: null,
      driverAnalysis: { primaryDriver: 'multi_system' as const, secondaryDriver: null, driverScore: 50, driverExplanation: '', actionableInsight: '' },
    };
    ...
    days.push({
      ...
      iaci: i === 0 ? (useDailyStore.getState().iaci ?? null) : { // Use real IACI for today
        ...
        protocol: {
          ...
          confidenceNote: null,
          driverInsight: null,
          permutationKey: 'band_B_none_medium_none',
        },
        baseScore: score,
